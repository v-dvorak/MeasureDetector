...
def draw_rectangles(image_path, coordinates: list[tuple[tuple[float, float, float, float], float, int]], classes: int, threshold:float=0.5):
    """
...
def draw_rectangles_with_conf(image_path, coordinates: list[tuple[tuple[float, float, float, float], float, int]], classes: int, threshold: float = 0.5):
    """
